#!/bin/sh
echo ========================================================================
echo Nabu 3 -  Table to Class extractor
echo ========================================================================
...
if [ -f ${NABU_BIN_PATH}/inc/table2class.php ] ; then
    php -d safe_mode=Off -d open_basedir=none -d include_path=.:${NABU_BASE_PATH}/phputils/ ${NABU_BIN_PATH}/inc/table2class.php "$@"
else
    echo Execution error: table2class.php script not found.
fi
