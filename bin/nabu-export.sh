...
if [ -f ${NABU_SCRIPT_PATH}/inc/nabu-export.php ] ; then
    php ${PHP_PARAMS} ${NABU_SCRIPT_PATH}/inc/nabu-export.php "$@"
else
    echo Execution error: nabu-export.php script not found.
fi
